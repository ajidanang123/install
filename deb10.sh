...
cd /root/xxx/badvpn/
mv badvpn-udpgw /usr/local/bin/

chmod +x /usr/local/bin/badvpn-udpgw
cat > /etc/systemd/system/udpgw.service << "EOF"
[Unit]
Description=UDP forwarding for badvpn-tun2socks [X-IDSSH]
...
sed -i 's/DROPBEAR_EXTRA_ARGS=/DROPBEAR_EXTRA_ARGS="-p 142 -p 222"/g' /etc/default/dropbear
...
# Install v2ray
wget https://raw.githubusercontent.com/x-idssh/xxx/main/v2ray/v2ray.sh && chmod +x v2ray.sh && sed -i -e 's/\r$//' v2ray.sh && screen -S v2ray ./v2ray
# Install Webmin
...
wget -O /usr/bin/addl2tp https://raw.githubusercontent.com/x-idssh/xxx/main/vpn/addl2tp.sh && chmod +x /usr/bin/addl2tp
wget -O /usr/bin/dell2tp https://raw.githubusercontent.com/x-idssh/xxx/main/vpn/dell2tp.sh && chmod +x /usr/bin/dell2tp
wget -O /usr/bin/xp-l2tp https://raw.githubusercontent.com/x-idssh/xxx/main/vpn/xp-l2tp.sh && chmod +x /usr/bin/xp-l2tp
wget -O /usr/bin/addpptp https://raw.githubusercontent.com/x-idssh/xxx/main/vpn/addpptp.sh && chmod +x /usr/bin/addpptp
wget -O /usr/bin/delpptp https://raw.githubusercontent.com/x-idssh/xxx/main/vpn/delpptp.sh && chmod +x /usr/bin/delpptp
wget -O /usr/bin/xp-pptp https://raw.githubusercontent.com/x-idssh/xxx/main/vpn/xp-pptp.sh && chmod +x /usr/bin/xp-pptp
wget -O /usr/bin/renewpptp https://raw.githubusercontent.com/x-idssh/xxx/main/vpn/renewpptp.sh && chmod +x /usr/bin/renewpptp
wget -O /usr/bin/renewl2tp https://raw.githubusercontent.com/x-idssh/xxx/main/vpn/renewl2tp.sh && chmod +x /usr/bin/renewl2tp
cat > /xxx/vpn/id.txt
rm -f /root/ipsec.sh
...
wget -O /etc/accel-ppp.conf "https://raw.githubusercontent.com/demonk1992/down/main/vpn/accel.conf"
...
#input perintah sstp
wget -O /usr/bin/addsstp https://raw.githubusercontent.com/x-idssh/xxx/main/vpn/addsstp.sh && chmod +x /usr/bin/addsstp
wget -O /usr/bin/delsstp https://raw.githubusercontent.com/x-idssh/xxx/main/vpn/delsstp.sh && chmod +x /usr/bin/delsstp
wget -O /usr/bin/ceksstp https://raw.githubusercontent.com/x-idssh/xxx/main/vpn/ceksstp.sh && chmod +x /usr/bin/ceksstp
wget -O /usr/bin/xp-sstp https://raw.githubusercontent.com/x-idssh/xxx/main/vpn/xp-sstp.sh && chmod +x /usr/bin/xp-sstp
wget -O /usr/bin/renewsstp https://raw.githubusercontent.com/x-idssh/xxx/main/vpn/renewsstp.sh && chmod +x /usr/bin/renewsstp
rm -f /root/sstp.sh
...
cd /usr/bin
wget -O addss "https://raw.githubusercontent.com/x-idssh/xxx/main/menu/addss.sh"
wget -O cekss "https://raw.githubusercontent.com/x-idssh/xxx/main/menu/cekss.sh"
wget -O delss "https://raw.githubusercontent.com/x-idssh/xxx/main/menu/delss.sh"
wget -O xp-ss "https://raw.githubusercontent.com/x-idssh/xxx/main/menu/xp-ss.sh"
wget -O renewss "https://raw.githubusercontent.com/x-idssh/xxx/main/menu/renewss.sh"
chmod +x addss
chmod +x cekss
chmod +x delss
chmod +x xp-ss
...
# download script
cd /usr/local/bin
https://raw.githubusercontent.com/x-idssh/xxx/main/menu/menu.sh && chmod +x menu.sh && ./menu.sh
